...
public class SQLExampleCdcKafkaTs_Ms {
    public static void main(String[] args) throws Exception {
        ...
        String ddlSource = "CREATE TABLE source (\n" +
                "  id INT,\n" +
                "  k INT,\n" +
                "  c STRING,\n" +
                "  pad STRING,\n" +
...
//                " 'sink.buffer-flush.max-rows' = '1',\n" +
        ...
        String job = " INSERT INTO sink(id,k,c,pad) SELECT id,k,c,pad,remark,ts_ms FROM source\n";
