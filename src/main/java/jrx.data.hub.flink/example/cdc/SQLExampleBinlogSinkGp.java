...
public class SQLExampleBinlogSinkGp {
...
//                "        `create_time` timestamp  ,\n" +
                ...
                "    'connector.url' = 'jdbc:postgresql://172.16.103.105:5432/postgres?reWriteBatchedInserts=true',\n" +
                "    'connector.table' = 'bm_acct_loan', \n" +
